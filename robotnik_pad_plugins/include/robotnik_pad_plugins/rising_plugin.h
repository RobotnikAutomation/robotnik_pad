...
protected:
  ...
  int button_power_off_arm_, button_power_on_arm_;
  ...
  ros::Publisher ackermann_pub_, pad_status_pub_, right_wheel_pub_, left_wheel_pub_, front_flipper_wheel_pub_, back_flipper_wheel_pub_, twist_pub_, test_pub_,water_record_pub_,toggle_arm_pub_;
...
ros::ServiceClient tube_extensor_srv_;
  int tube_enable_pin_,tube_rollup_pin_,tube_unroll_pin_,back_tube_rollup_pin_,back_tube_unroll_pin_;
